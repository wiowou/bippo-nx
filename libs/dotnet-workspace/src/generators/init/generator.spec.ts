...
import { nestJsSchematicsVersion, nestJsVersion, nxVersion } from '../../utils/versions';
...
describe('init generator', () => {
  ...
  it('should add dependencies', async () => {
    ...
    expect(packageJson.dependencies['@nestjs/platform-express']).toBe(nestJsVersion);
    ...
    expect(packageJson.devDependencies['@nestjs/schematics']).toBe(nestJsSchematicsVersion);
