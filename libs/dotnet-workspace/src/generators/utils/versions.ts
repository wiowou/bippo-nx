...
export const bippoAwsServiceVersion = '^0.1.26';
export const bippoDotnetVersion = '^0.0.8';
export const bippoDotnetAwsServiceVersion = '^0.0.16';
export const bippoTerraformVersion = '^0.1.19';
