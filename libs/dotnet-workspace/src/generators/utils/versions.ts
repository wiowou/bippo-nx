...
export const bippoAwsServiceVersion = '^0.1.36';
export const bippoDotnetVersion = '^0.0.10';
export const bippoDotnetAwsServiceVersion = '^0.0.26';
export const bippoTerraformVersion = '^0.1.29';
