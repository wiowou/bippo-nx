...
import { ServiceGeneratorSchema, NormalizedServiceGeneratorSchema } from '../schema';

export function normalizeOptions(tree: Tree, options: ServiceGeneratorSchema): NormalizedServiceGeneratorSchema {
